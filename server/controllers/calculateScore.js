function calculateScores(report) {
  ...
  if (dayRestDuration <= 60) {
    ...
    dayrestscore = 5;
  } else if (dayRestDuration <= 135) {
    dayrestscore = 0;
  } else if (dayRestDuration <= 150) {
    dayrestscore = -5;
  }
